    ...
    render() {
        return (
            <div className="main">
                ...
                <form>
                    <input placeholder="시작날짜(20220101형태)" name="startCreateDt" onChange={this.onChange}/>
                    <input placeholder="종료날짜(20220101형태)" name="endCreateDt" onChange={this.onChange}/>
